...
const deliveryOptions = [
    ...
    { name: "Option B", price: "$15.00", time: "5 days", emissions: "800 Kg CO2" },
    { name: "Option C", price: "$20.00", time: "2 days", emissions: "500 Kg CO2" }
];
        ...
        <div className='deliveryOptionsSection'>
            ...
            <Grid container className="deliveryContainer" spacing={2}>
                {deliveryOptions.map((option, index) => (
                    <Grid key={index} item md={4} xs={12} className="deliveryOption">
